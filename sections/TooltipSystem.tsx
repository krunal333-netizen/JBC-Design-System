        ...
        <div className="flex flex-wrap items-center gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl border border-dashed border-black/10 dark:border-white/10 flex items-center gap-3">
              ...
              <JBCTooltip
                content="Annual Percentage Rate. The yearly interest generated by a sum that's charged to borrowers or paid to investors."
                maxWidth={250}
              >
                <span className="text-sm font-bold text-jbc-cyan border-b border-dotted border-jbc-cyan cursor-help">
                  APR 12.4%
                </span>
              </JBCTooltip>
            </div>
        ...
        <div className="relative bg-[#0D1117] border border-black/10 dark:border-[#30363D] rounded-2xl p-8 group overflow-hidden">
          <pre className="font-mono text-sm leading-relaxed overflow-x-auto text-[#E6EDF3]">
            <code>
              ...
              &lt;JBCTooltip content="View Details" placement="top"&gt;<br />
              &nbsp;&nbsp;&lt;JBCButton&gt;Inspect&lt;/JBCButton&gt;<br />
              &lt;/JBCTooltip&gt;<br /><br />

              <span className="text-[#8B949E] italic">// Rich content support</span><br />
              &lt;JBCTooltip content={'{'}(<br />
              &nbsp;&nbsp;&lt;div&gt;Estimated TVL &lt;strong&gt;$1.2B&lt;/strong&gt;&lt;/div&gt;<br />
              ){'}'} maxWidth={'{'}250{'}'}&gt;<br />
